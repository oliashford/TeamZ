...
namespace TeamZ.Characters.Core
{
    public class CameraController : MonoBehaviour
    {
        ...
        [Tooltip("Transform to follow (usually character's look-at point)")]
        ...
        [Tooltip("Distance from the player target")]
        [SerializeField] private float _cameraDistance = 5f;
        [Tooltip("Vertical offset from player target")]
        [SerializeField] private float _cameraHeightOffset;
        [Tooltip("Horizontal offset from player target")]
        [SerializeField] private float _cameraHorizontalOffset;
        [Tooltip("Additional camera tilt angle offset")]
        [SerializeField] private float _cameraTiltOffset;
        [Tooltip("Min/max vertical camera rotation bounds")]
        [SerializeField] private Vector2 _cameraTiltBounds = new Vector2(-10f, 45f);
        [Tooltip("How smoothly camera follows position (higher = less lag)")]
        [SerializeField] private float _positionalCameraLag = 1f;
        [Tooltip("How smoothly camera follows rotation (higher = less lag)")]
